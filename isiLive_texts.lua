...
local LOCALES = {
  enUS = {
    ...
    TOOLTIP_SYNC_FRESHNESS = "Sync age: %s",
    TOOLTIP_SYNC_SOURCE = "Source: %s",
    TOOLTIP_SYNC_VERSION = "Peer version: %s (p%d)",
    ...
    SETTINGS_DM_RESET = "Blizzard DamageMeter Reset on Dungeon Entry",
    SETTINGS_ESC_PANEL = "Show ESC Menu Shortcuts",
    ...
    SETTINGS_AUTO_OPEN_QUEUE = "Auto-Open on M+ Queue",
    SETTINGS_AUTO_CLOSE_MAIN_FRAME = "Auto-Close on Key Start / Solo",
  ...
  deDE = {
    ...
    TOOLTIP_SYNC_FRESHNESS = "Sync-Alter: %s",
    ...
    SETTINGS_DM_RESET = "Blizzard DamageMeter Reset bei Dungeon-Eintritt",
    SETTINGS_ESC_PANEL = "ESC-Schnellzugriff anzeigen",
    SETTINGS_BG_ALPHA = "Hintergrund-Deckkraft",
    SETTINGS_ROSTER_COLUMN_GUIDES = "Spaltenlinien",
    ...
    SETTINGS_DEFAULT_OPEN_UI = "Standard-UI beim Oeffnen",
    ...
    SETTINGS_SYNC_ENABLED = "Addon-Sync",
    SETTINGS_SHOW_DPS_COLUMN = "DPS-Spalte anzeigen",
    SETTINGS_MINIMAP_BUTTON = "Minimap-Button",
    SETTINGS_AUTO_OPEN_QUEUE = "Auto-Open bei M+ Queue",
    SETTINGS_AUTO_CLOSE_MAIN_FRAME = "Auto-Close bei Key-Start / Solo",
    SETTINGS_AUTO_SHOW_MAIN_FRAME_ON_STARTUP = "Beim Login / Reload anzeigen",
    SETTINGS_AUTO_OPEN_MAIN_FRAME_ON_KEY_END = "Bei Key-Ende automatisch oeffnen",
    SETTINGS_RAID_TRANSITION_BEHAVIOR = "Raid-Verhalten",
    ...
    SETTINGS_SHOW_TIMEWAYS_NAVIGATOR = "Zeitwege-Navigator anzeigen",
