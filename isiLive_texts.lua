...
local LOCALES = {
  enUS = {
    ...
    BTN_SECOND_ARKANATINE_KEY = "Ark. Key",
    ...
    SETTINGS_COMBAT_LOGGING = "Advanced Combat Logging",
    SETTINGS_DM_RESET = "DM Reset on Dungeon Entry",
    ...
    SETTINGS_AUTO_HIDE_SOLO = "Auto-Hide when Solo",
  ...
  deDE = {
    ...
    BTN_GAMEMENU_RELOADUI = "ReloadUI",
    BTN_SECOND_ARKANATINE_KEY = "Ark.-Schlüssel",
    BTN_SECOND_HEARTHSTONE = "Hearthstone",
    BTN_SECOND_HOUSING = "Grundstück",
    ...
    SETTINGS_COMBAT_LOGGING = "Erweitertes Combat Logging",
    SETTINGS_DM_RESET = "DM Reset bei Dungeon-Eintritt",
    ...
    SETTINGS_AUTO_HIDE_SOLO = "Auto-Hide wenn Solo",
