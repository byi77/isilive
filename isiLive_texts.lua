...
local LOCALES = {
  enUS = {
    ...
    TOOLTIP_LAST_RUN_DEATHS = "Last run deaths: %s",
    TOOLTIP_LAST_RUN_KICKS = "Last run kicks: %s",
  ...
  deDE = {
    ...
    TOOLTIP_LAST_RUN_DEATHS = "Tode letzter Run: %s",
    TOOLTIP_LAST_RUN_KICKS = "Kicks letzter Run: %s",
    ANNOUNCE_PREFIX = "Party Keys:",
