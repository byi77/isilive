...
local LOCALES = {
  enUS = {
    ...
    SETTINGS_RAID_TRANSITION_BEHAVIOR = "Behavior when switching to raid",
  ...
  deDE = {
    ...
    SETTINGS_RAID_TRANSITION_BEHAVIOR = "Verhalten beim Wechsel in den Raid",
    SETTINGS_RAID_TRANSITION_BEHAVIOR_SHOW_H = "Anzeigen + H",
    SETTINGS_RAID_TRANSITION_BEHAVIOR_SHOW_KEEP = "Anzeigen + Layout",
    SETTINGS_RAID_TRANSITION_BEHAVIOR_PRESERVE = "Zustand behalten",
