...
local registryData = addonTable.SoundRegistry
SoundUtils.Registry = type(registryData) == "table" and registryData.Registry or {}
SoundUtils.SettingsOrder = type(registryData) == "table" and registryData.SettingsOrder or {}
