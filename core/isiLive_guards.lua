...
local REQUIRED_MODULES = {
  ...
  { key = "PiTracker", file = "isiLive_pi_tracker.lua" },
  { key = "ActionButtonOverlay", file = "isiLive_action_button_overlay.lua" },
  { key = "BloodlustButtonWarning", file = "isiLive_bloodlust_button_warning.lua" },
  { key = "VipDkAssist", file = "isiLive_vip_dk_assist.lua" },
  { key = "DeathWatch", file = "isiLive_death_watch.lua" },
  { key = "DeathAlert", file = "isiLive_death_alert.lua" },
...
local REQUIRED_FUNCTIONS = {
  ...
  { path = { "VipDkAssist", "CreateController" }, message = "isiLive: VipDkAssist.CreateController missing" },
  { path = { "VipDkAssist", "SetDependencies" }, message = "isiLive: VipDkAssist.SetDependencies missing" },
  { path = { "VipDkAssist", "HandleEvent" }, message = "isiLive: VipDkAssist.HandleEvent missing" },
  ...
  { path = { "DeathWatch", "CreateController" }, message = "isiLive: DeathWatch.CreateController missing" },
  { path = { "DeathWatch", "SetDependencies" }, message = "isiLive: DeathWatch.SetDependencies missing" },
  { path = { "DeathWatch", "HandleEvent" }, message = "isiLive: DeathWatch.HandleEvent missing" },
  { path = { "DeathAlert", "CreateController" }, message = "isiLive: DeathAlert.CreateController missing" },
  { path = { "DeathAlert", "ShowRoleDeath" }, message = "isiLive: DeathAlert.ShowRoleDeath missing" },
