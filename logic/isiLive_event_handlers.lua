...
local function BuildContext(opts)
  ...
  ctx.playReadyCheckCompleteSound = OptionalFunction(opts.playReadyCheckCompleteSound, function() end)
  ctx.saveReloadRosterMirror = OptionalFunction(opts.saveReloadRosterMirror, function() end)
  ...
  ctx.handleBloodlustButtonWarningEvent = OptionalFunction(
    opts.handleBloodlustButtonWarningEvent,
    function(_event, ...) end
  )
