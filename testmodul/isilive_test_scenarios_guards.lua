...
local function RegisterGuardsValidationTests(test, Assert, WithGlobals, LoadAddonModules)
  test("Guards validates all required modules are present", function()
    WithGlobals({
      CreateFrame = CreateFrameStub,
    }, function()
      local addon = LoadAddonModules(REQUIRED_MODULES)
...
local function RegisterMainAddonGuardFailureTest(test, Assert, WithGlobals, LoadAddonModules)
...
return function(test, ctx)
  ...
  RegisterGuardsValidationTests(test, Assert, WithGlobals, LoadAddonModules)
  RegisterMainAddonGuardFailureTest(test, Assert, WithGlobals, LoadAddonModules)
end
