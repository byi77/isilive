...
local function RegisterSettingsPanelOrderTests(test, Assert, WithGlobals, LoadAddonModules)
  test("Settings panel orders controls by thematic sections", function()
    ...
    WithGlobals({
      ...
      local panel = addon.SettingsPanel.Create({
        getL = function()
          return {
            ...
            SETTINGS_VIP_DK_SEPARATOR = "VIP DK separator",
      ...
      AssertBefore("SETTINGS_VIP_GILDED_BRUTOSAUR_SOUND", "SETTINGS_VIP_BLOODLUST_DEBUFF_BUTTON_WARNING")
      AssertBefore("SETTINGS_VIP_BLOODLUST_DEBUFF_BUTTON_WARNING", "SETTINGS_VIP_DK_SEPARATOR")
      AssertBefore("SETTINGS_VIP_DK_SEPARATOR", "SETTINGS_VIP_DK_SOUL_REAPER_WARNING")
      AssertBefore("SETTINGS_VIP_DK_SOUL_REAPER_WARNING", "SETTINGS_VIP_DK_PUTREFY_WARNING")
      AssertBefore("SETTINGS_VIP_DK_PUTREFY_WARNING", "SETTINGS_VIP_DK_APOCALYPSE_HORSE_SOUND")
