...
return function(test, ctx)
  ...
  test("DBSchema.Sanitize fills all defaults on an empty db", function()
    ...
    Assert.Equal(db.soundPetStuckEnabled, true, "pet stuck sound default true")
    ...
    Assert.NotNil(db.verifiedAccountTeleportSpells, "verified account teleport cache default table")
  ...
  test("DBSchema.GetKnownFieldNames includes core persistent fields", function()
    ...
    Assert.Equal(known.verifiedAccountTeleportSpells, true, "verifiedAccountTeleportSpells must be in known fields")
    ...
    Assert.Equal(known.soundPetStuckEnabled, true, "soundPetStuckEnabled must be in known fields")
