...
return function(test, ctx)
  ...
  test("ConfigBuilders BuildQueueFlowControllerOpts passes all fields", function()
    ...
    local ctx_input = {
      ...
      resolveMapIDByActivityID = MakeSentinel("resolveMapIDByActivityID"),
      resolveTeleportSpellIDByMapID = MakeSentinel("resolveTeleportSpellIDByMapID"),
      resolveJoinedKeyMapID = MakeSentinel("resolveJoinedKeyMapID"),
      updateMPlusTeleportButton = MakeSentinel("updateMPlusTeleportButton"),
      showInviteHint = MakeSentinel("showInviteHint"),
      updateUI = MakeSentinel("updateUI"),
      printFn = MakeSentinel("printFn"),
      setQueueTargetState = MakeSentinel("setQueueTargetState"),
      queueCaptureQueueJoinCandidate = MakeSentinel("queueCaptureQueueJoinCandidate"),
  ...
  test("ConfigBuilders BuildTestModeControllerOpts passes all fields", function()
    ...
    local ctx_input = {
      ...
      showQueueJoinPreview = MakeSentinel("showQueueJoinPreview"),
