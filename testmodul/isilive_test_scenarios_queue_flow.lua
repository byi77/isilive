local function RegisterQueueFlowResolverAndUpdateTests(test, Assert, WithGlobals, LoadAddonModules, Fixtures)
...
local function RegisterQueueFlowCaptureAndDedupTests(test, Assert, LoadAddonModules, Fixtures)
...
return function(test, ctx)
  ...
  RegisterQueueFlowResolverAndUpdateTests(test, Assert, WithGlobals, LoadAddonModules, Fixtures)
  RegisterQueueFlowAnnounceTests(test, Assert, LoadAddonModules, Fixtures)
  RegisterQueueFlowCaptureAndDedupTests(test, Assert, LoadAddonModules, Fixtures)
end
