...
local function BuildGroupControllerOptions(state, overrides)
  ...
  return {
    ...
    unitExists = overrides.unitExists or function(_unit)
      return true
    end,
    getRaidTargetIndex = overrides.getRaidTargetIndex or function(_unit)
      return nil
    end,
...
local function RegisterGroupAutoMarkTests(test, Assert, LoadAddonModules)
  ...
  test("AutoMark assigns markers even when player is not group leader", function()
    ...
    local controller = select(
      ...
      BuildGroupController(LoadAddonModules, {
        ...
        unitIsGroupLeader = function(_unit)
          return false
        end, -- NOT leader
        unitExists = function(_unit)
          return true
...
return function(test, ctx)
  ...
  RegisterGroupAutoMarkTests(test, Assert, LoadAddonModules)
end
