...
function UI.CreateMainFrame(opts)
    ...
    local isInCombat = opts.isInCombat or function() return InCombatLockdown and InCombatLockdown() end
    ...
    return {
        ...
        GetPendingVisible = function() return pendingVisible end,
        GetPendingHeight = function() return pendingHeight end,
    }
end
