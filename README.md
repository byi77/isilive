...
5. `tools/validate_usecases.lua` runs both validators first and then executes a modular deterministic runtime/structure gate (`testmodul/isilive_test_*.lua`) with 515 scenarios across 38 modules, while the rule validators currently index 515 deterministic tests, including:
