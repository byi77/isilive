...
Current documented baseline: `0.9.128`.
...
## Use Case / Logic Baseline (v0.9.128)

Documented on `2026-04-02` as runtime behavior baseline (`0.9.128`) for validation checks.
