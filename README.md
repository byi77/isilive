...
Current documented baseline: `0.9.127`.
...
## Use Case / Logic Baseline (v0.9.127)

Documented on `2026-04-02` as runtime behavior baseline (`0.9.127`) for validation checks.
