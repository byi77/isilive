...
3. Rule: protected or string-tainted aura `spellId` values must be normalized safely via `tonumber(...)`; unusable values must be ignored without aborting the full lust scan.
