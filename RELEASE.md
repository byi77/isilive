...
`tools/validate_usecases.lua` is mandatory for release gating, runs both rule validators first, and then validates 417 deterministic tests indexed and 424 scenarios across 37 modules.
