...
`tools/validate_usecases.lua` is mandatory for release gating, runs both rule validators first, and then validates 391 deterministic tests indexed and 395 scenarios across 34 modules.
