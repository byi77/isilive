...
`tools/validate_usecases.lua` is mandatory for release gating, runs both rule validators first, and then validates 423 deterministic tests indexed and 428 scenarios across 37 modules.
