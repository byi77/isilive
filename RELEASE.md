...
`tools/validate_usecases.lua` is mandatory for release gating, runs both rule validators first, and then validates 402 deterministic tests indexed and 406 scenarios across 34 modules.
