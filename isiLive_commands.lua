...
function Commands.RegisterSlashCommands(opts)
    ...
    local getL = opts.getL or function() return {} end
    local getState = opts.getState or function() return {} end
    local setState = opts.setState or function(_) end
    ...
    local setMainFrameVisible = opts.setMainFrameVisible or function(_) end
    local updateLeaderButtons = opts.updateLeaderButtons or function(...) end
    local isPlayerLeader = opts.isPlayerLeader or function() return false end
    local setLanguage = opts.setLanguage or function(_) end
