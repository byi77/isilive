...
12. Regel: Wenn die Addon-Sprache `ruRU` aktiv ist, nutzen lokalisierte Hauptfenster-Texte und gefittete Button-Labels einen kyrillisch-faehigen Font, damit russische Zeichen auch auf nicht-russischen WoW-Clients nicht als Platzhalterkaestchen erscheinen.
...
Aktuelle Validator-Baseline: `1883` Szenarien ueber die in `tools/usecase_scenarios.lua` registrierten Module.
