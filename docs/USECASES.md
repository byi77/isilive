...
3. Verarbeitung: Das Queue-Handling speichert nur den Kontext fuer einen gruppierten Join und darf Dungeon-/Teleport-Ziele nur aus eindeutig verifiziertem Activity-/Map-Kontext ableiten. Mehrdeutige `activityIDs`, fehlende Maps oder reine Namen bleiben unresolved.
