...
- Zielplattform ist ausschliesslich WoW-Patch `12.1.0+`.
- `<12.1.0` gilt als unsupported/incompatible; dafuer wird kein Legacy-Kompatibilitaetscode hinzugefuegt. Der 12.0.7-Support wurde mit 0.9.383 eingestellt.
