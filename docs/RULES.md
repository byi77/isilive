...
- Keep enforceable architecture contracts in `ARCHITECTURE_RULES.md` with stable `RULE-ID` blocks.
...
- Active architecture rules are also part of the mandatory gate through `lua tools/validate_usecases.lua`; do not merge structural refactors without a green architecture/rules/usecase run.
