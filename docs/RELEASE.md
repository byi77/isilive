...
`tools/validate_usecases.lua` ist Pflicht fuer das Release-Gate, fuehrt beide Regelvalidatoren zuerst aus und validiert danach 536 Szenarien ueber 39 Module. Die Regelvalidatoren indizieren aktuell 536 deterministische Tests.
