...
5. `tools/validate_usecases.lua` fuehrt beide Validatoren zuerst aus und deckt danach 510 Szenarien ueber 37 Module ab; die Regelvalidatoren indizieren aktuell 510 deterministische Tests.
