...
5. `tools/validate_usecases.lua` fuehrt beide Validatoren zuerst aus und deckt danach 2137 Szenarien ueber die aktuell registrierten Module (siehe `tools/usecase_scenarios.lua`) ab; die Regelvalidatoren indizieren die entsprechenden deterministischen Tests.
...
```text
| isiLive v0.9.338 BETA                                  Open/Close CTRL-F9 [M+][H][V][Gear][L][X]                 |
|------------------------------------------------------------------------------------------------------------------|
...
| BloodlustButtonWarning | VIP-Bloodlust-Debuff-Button-Warnung | Default-aktive VIP-Option; markiert nur fuer verifizierte lokale Bloodlust-Klassen und verifizierte Erschoepfungs-/Satt-Auren sichtbare Actionbar-Buttons mit exakten Bloodlust-Klassen-/Pet-Spell-IDs; Drums, Namen, Icons und unverifizierte Quellen bleiben stumm |
...
13. **VIP-Gast-Einstellungen:** VIP-Mount-Sound-Mutes, default-aus VIP-DK-Seelenernter-/Putrefy-Warnungen inklusive eingeruecktem Pferdeklang-Mute und verschiebbarem Ghoul-Reminder sowie die default-aus VIP-Bloodlust-Debuff-Button-Warnung.
