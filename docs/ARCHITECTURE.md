...
5. `tools/validate_usecases.lua` fuehrt beide Validatoren zuerst aus und deckt danach 1918 Szenarien ueber die aktuell registrierten Module (siehe `tools/usecase_scenarios.lua`) ab; die Regelvalidatoren indizieren die entsprechenden deterministischen Tests.
...
```text
| isiLive                                                 v0.9.290 Open/Close CTRL-F9 [H][V][M][M+][L][X]            |
|------------------------------------------------------------------------------------------------------------------|
