...
80. Der Tank-/Heiler-Todesalarm zeigt nur waehrend eines aktiven M+-Runs beim Uebergang lebendig zu tot einmalig eine grosse rote Bildschirmwarnung mit statischer WAV-Ansage; derselbe DeathWatch-Pfad zaehlt pro Spieler die beobachteten Key-Tode fuer Roster-Marker, Roster-Tooltip und den M+-Totenkopf-Tooltip; der Death-Alert-Master-Gate schaltet die Erkennung und Bildschirmwarnung gemeinsam, waehrend Tank- und Heiler-WAVs eigene Sound-Schalter haben; fehlgeschlagene Tank-/Heiler-WAV-Starts muessen diagnostizierbar sein.
...
- Erforderliche Tests:
  ...
  - DeathWatch tracks per-player death counts until a new challenge starts
