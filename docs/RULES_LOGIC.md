...
80. Der Tank-/Heiler-Todesalarm zeigt nur waehrend eines aktiven M+-Runs beim Uebergang lebendig zu tot einmalig eine grosse rote Bildschirmwarnung mit TTS-Ansage; derselbe DeathWatch-Pfad zaehlt pro Spieler die beobachteten Key-Tode fuer Roster-Marker, Roster-Tooltip und den M+-Totenkopf-Tooltip; ein einzelner Settings-Schalter schaltet Text und Sound gemeinsam.
...
- Erforderliche Tests:
  ...
  - DeathWatch keeps counting damage-dealer deaths even when TTS is suppressed
