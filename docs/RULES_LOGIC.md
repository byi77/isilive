...
78. Eingebaute Soundausgaben laufen standardmaessig ueber `Master`; `soundOutputChannel` akzeptiert nur `Master`/`SFX` und faellt geschlossen auf `Master` zurueck; gleiche Soundkeys werden fuer 3 Sekunden gegen Wiederholung geschuetzt.
...
84. Native WoW-Text-to-Speech-Ausgabe ist deaktiviert; Death- und Ready-Audio laufen ueber statische WAV-Dateien aus der Sound-Registry.
